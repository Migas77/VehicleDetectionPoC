...
from app.drivers.ues import ues_interface
...
async def _verify_camera_qos_profiles(camera_ues: list[CameraUE]) -> None:
...
async def lifespan(_app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    await _verify_camera_qos_profiles(camera_ues)
