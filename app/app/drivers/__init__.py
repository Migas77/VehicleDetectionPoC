...
from app.drivers.crash_inference import router as crash_inference_router
from app.drivers.geofencing import router as geofencing_router
...
router.include_router(crash_inference_router)
